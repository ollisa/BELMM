...
generated quantities{ 
   ...
   logModel = log_sum_exp(log_theta) +normal_lpdf(l[1,1]|l_init[1],20) + normal_lpdf(l[1,2:T] |l[1,1:(T-1)],sigma_y ) +normal_lpdf(l[2,1]|l_init[2],20) + normal_lpdf(l[2,2:T] |l[2,1:(T-1)],sigma_y )+normal_lpdf(l[3,1]|l_init[3],20) + normal_lpdf(l[3,2:T] |l[3,1:(T-1)],sigma_y );
}
